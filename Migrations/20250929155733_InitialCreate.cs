        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    coordenadas_limite = table.Column<double>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    codigo_tag = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    data_vinculo = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_operacao = table.Column<DateTime>(type: "datetime2", nullable: false),
                    valores_novos = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    codigo_tag = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    id_setor = table.Column<int>(type: "int", nullable: false),
                    id_audit = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
